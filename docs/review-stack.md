...
This checkout is layer 1: Minimal working Codex chat. Each layer includes its own running application and tests. The original PRs #2–#6 remain available for testing; the obsolete feature stack #7–#12 is closed.
